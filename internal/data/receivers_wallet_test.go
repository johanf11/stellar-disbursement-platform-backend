	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: strings.Join([]string{
				...
				"updated_at",
				"invitation_sent_at",
				`COALESCE(sep24_transaction_id, '') AS "sep24_transaction_id"`,
		...
		},
		{
			...
			expected: strings.Join([]string{
				...
				`COALESCE(rw.sep24_transaction_id, '') AS "sep24_transaction_id"`,
		...
		},
		{
			...
			expected: strings.Join([]string{
				...
				`COALESCE(rw.sep24_transaction_id, '') AS "receiver_wallets.sep24_transaction_id"`,
